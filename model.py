...
class MaskRCNN():
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        val_generator = data_generator(val_dataset, self.config, shuffle=True,
                                       batch_size=self.config.BATCH_SIZE,
                                       augment=False)
        # train_generator = DataGenerator(train_dataset, self.config, shuffle=True, batch_size=self.config.BATCH_SIZE)
        ...
        callbacks = [
            ...
            keras.callbacks.ModelCheckpoint(self.checkpoint_path, verbose=0, save_weights_only=True, period=10), ]
